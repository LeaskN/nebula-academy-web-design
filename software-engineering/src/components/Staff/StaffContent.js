...
import ManamiImage from "../../assets/Manami-Ueda-Profile.jpg"
import TefeImage from "../../assets/Tefe-profile.jpg"
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            allPeople: [ 
                ...
                { name: 'Manami Ueda', refName: 'ManamiUeda', position:'Software Engineer & Software Engineering Instructor', linkText: `Manami's LinkedIn`, url: 'https://www.linkedin.com/in/manami-ueda/', image: ManamiImage, bio: 'Manami is a Software Engineer and Instructor at Nebula Academy’s Part-Time Bootcamp program. Originally from Chicago, she moved to New York City after graduating from Loyola University’s MBA program in 2017. She joined an advertisement technology company as a Business Development Associate and started learning coding on her own on the side. She graduated from Fullstack Academy’s Immersive Coding Bootcamp in February 2020 and her next goal is to positively impact and contribute to Nebula Academy by using her new coding and tech skills.'},
