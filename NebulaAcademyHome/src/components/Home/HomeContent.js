...
class HomeContent extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            'educators': { color: '#993955', header:"Educators", content: "We are educators and technologists working together to better education through Computer Science and STEAM integration in and out of the classroom in partnership with industry." , buttonURL:'educators', buttonText: 'Learn More' }, 
            ...
            'philanthropy': { color: '#9395D3', header:"Philanthropy", content: "Nebula Academy is a social enterprise institution. Through our not-for-profit entity, We Connect The Dots, we aspire to help our community and world by giving back. Learn more on the types of programs we have and how you can give back! " , buttonURL:'philanthropy', buttonText: 'Learn More' },
        };
    }
    createSlideCard = () => {
        return(
