        ...
        <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto navContents">
                ...
                <NavDropdown title="Workforce Development" id="basic-nav-dropdown">
                    <NavDropdown.Item href="/workforce-development">Workforce Development</NavDropdown.Item>
                    <NavDropdown.Item href="/workshops">All Workshops</NavDropdown.Item>
                    <NavDropdown.Item href="/workshops/1">Workshop: Jobs in Tech</NavDropdown.Item>
                    <NavDropdown.Item href="/workshops/2">Workshop: Tech Sales</NavDropdown.Item>
                    <NavDropdown.Item href="/workshops/3">Workshop: Tech Support</NavDropdown.Item>
                    <NavDropdown.Item href="/workshops/4">Workshop: Software Engineer</NavDropdown.Item>
                </NavDropdown>
