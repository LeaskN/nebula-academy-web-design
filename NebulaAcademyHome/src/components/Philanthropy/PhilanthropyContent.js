...
class Philanthropy extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            helpOut: [
                {title: 'Scholarships', shortDescription:'Be a Part of Positive Systemic Change', buttonText:'View Scholarships', url: 'https://www.we-connect-the-dots.org/scholarships-1', description: 'By funding through our scholarship programs you can contribute to transforming one or more lives to build a sustainable future.  This form of contribution to society creates a ripple effect in how we demonstrate the value of a diverse workforce and shape the lives of not only the recipient of the scholarship but their families and communities they live in. Create a broad reach addressing the need of young and old through a scholarship, be a part of the change. Learn more about the scholarship opportunities:'},
                ...
                {title: 'Sponsor', shortDescription:'Corporate and Social Responsibility Through Sponsorship', buttonText:'Sponsorship Opportunities', url: 'https://we-connect-the-dots.org/sponsorship', description: <div>Nebula Academy & We Connect The Dots continues to impact hundreds of students, adults, and educators each year from around the globe. Through collaboration with industry, government, and community partners we are creating systemic change to build capacity in technology workforce skills and in computer science education. As a research organization we provide our sponsors with social media exposure, video highlight reals, and metrics that demonstrate our impact in engaging underrepresented populations. We invite you to learn more about our organizations and how you can support our success by clicking the button below and making a general donation, sponsoring a program, or sponsoring a scholarship, 100% of your donations are invested in program support and delivery.</div>},
            ]
        };
    }
    createProgramCard = () => {
