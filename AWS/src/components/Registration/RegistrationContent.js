                ...
                <Tabs 
                                ...
                                <Col xs={12}>
                                    <Row>
                                        <Col className="alignCenter">
                                            ...
                                            <p style={{textAlign:'center'}}>Take a look below at the AWS Academy Programs that we currently provide for students.</p>
                    ...
                    <Tab eventKey="EDUCATOR" title="EDUCATOR">
                        ...
                        <Row className="registrationCard">
                            ...
                            <h3>AWS Academy Cloud Foundations - <b>Live Virtual</b></h3>
                            {/* <Alert variant="success" style={{textAlign:'center'}}>DUE TO THE COVID-19 OUTBREAK THIS COURSE PRICE HAS BEEN REDUCED TO $99</Alert> */}
                            <p>AWS Academy Cloud Foundations is intended for educators who seek an overall understanding of cloud computing concepts, independent of specific technical roles. It provides a detailed overview of cloud concepts, AWS core services, security, architecture, pricing, and support.</p>
                            <p>This course prepares you for the AWS Cloud Practitioner Certification Exam. Read about the certification <a href="https://aws.amazon.com/certification/certified-cloud-practitioner/">here</a>.</p>
                            <div>
                                The virtual session grants access to:
                                <ul>
                            ...
                            <div id="spacer"></div>
                            <Button className="bottom" variant="info" href="https://app.acuityscheduling.com/schedule.php?owner=13648189&appointmentType=15551859">Register</Button>
                            </Col>
                        </Row>
                    </Tab>
