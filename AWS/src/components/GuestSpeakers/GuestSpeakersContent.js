...
export const GuestSpeakersContent = () => (
  <React.Fragment>
    <Container>
      ...
      <p>If you work in the information technology field and would like to be considered to be a guest speaker for our programs, complete our registration form:</p>
