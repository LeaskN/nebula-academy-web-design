    ...
    <React.Fragment>
        <Container>
            <Row className="sections">
                {(window.location.href.split('/')[window.location.href.split('/').length-1]) === ''? <Col className="section current"><a className="customLink" href="/">What We Offer</a></Col> : <Col className="section"><a className="customLink" href="/">Overview</a></Col>}
