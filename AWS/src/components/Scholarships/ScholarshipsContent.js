...
export const ScholarshipsContent = () => (
  <React.Fragment>
    ...
    <p>The "Pathways to Success" program is currently offering 9 full scholarships to candidates who meet any of the populations outlined on this page.  registrations are now being accepted for review for the March program.</p>
