  ...
  <React.Fragment>
    <Container>
        ...
        <Row className="programRow"style={{color:"white", marginBottom: '20px'}}>
            <Col xs={12} lg={6} xl={4}>
                <div className="programTile1" id="programTile">
                    <div>
                        ...
                        <div id="spacer" style={{height: '140px'}}></div>
                        <ButtonMessage125 id="programButtonMessage"></ButtonMessage125>
                        {/* <Button style={{marginBottom: '125px'}} className="bottom contentCentered"  href="https://app.acuityscheduling.com/schedule.php?owner=13648189&appointmentType=13071791" variant="light" disabled>Register for In-Person</Button> */}
            ...
            <Col xs={12} lg={6} xl={4}>
                <div className="programTile2" id="programTile">
                    <div>
            ...
            <Col xs={12} lg={6} xl={4}>
                <div className="programTile3" id="programTile">
                    <div>
                        ...
                        <div id="spacer" style={{height: '140px'}}></div>
                        <ButtonMessage125 id="programButtonMessage"></ButtonMessage125>
                        {/* <Button style={{marginBottom: '125px'}} className="bottom contentCentered"  href="https://app.acuityscheduling.com/schedule.php?owner=13648189&appointmentType=13072072" variant="light" disabled>Register for In-Person</Button> */}
            ...
            <Col xs={12} lg={6} xl={4}>
                <div className="programTile3" id="drones" >
                    <div>
                        ...
                        <ButtonMessage75 id="programButtonMessage"></ButtonMessage75>
                        {/* <Button style={{marginBottom: '75px'}} className="bottom contentCentered"  href="https://app.acuityscheduling.com/schedule.php?owner=13648189&appointmentType=category:STEAM%20Drones%20Professional%20Development%20%28in-person%29" variant="light" disabled>Register For In-Person</Button> */}
            ...
            <Col xs={12} lg={6} xl={4}>
                <div className="programTile1" id="minecraftEd">
                    <div>
                        <h3 id="minecraft:EEHeader" className="programHeader">Minecraft: Education Edition</h3>
                        <p className="programText">Master the basic controls of Minecraft: Education Edition(EE), explore the inventory and build your first house! Travel via rail to experience a different mode of transport offered within this platform, investigate differing lesson ideas to show how MEE can be used in all curriculums / subjects in countless ways. By the end of the session, teachers should feel confident in using MEE and should have generated a plethora of ideas of how to use this amazing platform within their pedagogy.</p>
                        <div id="spacer" ></div>
            ...
            <Col xs={12} lg={6} xl={4}>
                <div className="programTile2" id="microsoftMIE">
                    <div>
                        <h3 id="microsoftMIEHeader" className="programHeader">Microsoft MIE</h3>
                        <p className="programText">Participants will spend the day getting excited about the many tools Microsoft has to offer students and teachers. Teachers will reflect and create a customized toolkit of resources to increase engagement, efficiency and develop modern skills for a global classroom/society.</p>
                        <p className="programText">Participants will engage in a series of immersive learning activities that will build a strong understanding of how to use technology to improve instruction and meet the learning needs of their students.</p>
                        <div id="spacer" ></div>
                        <Button style={{marginBottom: '25px'}}className="bottom contentCentered"  href="mailto:sales@neublaacademyny.com" variant="light">Get More Info</Button>
                    </div>
                </div>
