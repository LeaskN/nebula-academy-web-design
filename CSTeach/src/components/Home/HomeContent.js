                ...
                <Container>
                    <Row>
                        <Col xs={12} lg={6} xl={4} className="introRow1Column1">
                            <Card className="introRowTile">
                                <Card.Body>
                                    <h3 className="homeH3">There are 26k schools in the US and less than half teach Computer Science</h3>
                                    <Card.Text>
                        ...
                        <Col xs={12} lg={6} xl={4} className="introRow1Column2">
                            <Card className="introRowTile">
                                <Card.Body>
                                    <h3 className="homeH3">Going beyond "Hour of Code"</h3>
                                        {/* <ul>
                        ...
                        <Col xs={12} lg={12} xl={4} className="introRow1Column3">
                            <Card className="introRowTile">
                                <Card.Body>
                                    <h3 className="homeH3">Building Capacity for Computer Science</h3>
                                    <Card.Text>
                        ...
                        <Col xs={12} lg={12} xl={8} className="introRow2Tile1">
                            <Row>
                                <Col xl={6}>
                                    <Card className="introRowTile">
                                        <Card.Body>
                                            <h3 className="homeH3">Employment Statistics</h3>
                                ...
                                <Col xl={6}>
                                    <Card className="introRowTile">
                                        <Card.Body>
                                            ...
                                            <a href="/careers" className="linkLight homeLink">Click here to read more about job readiness.</a>
                    ...
                    <Row>
                        <Col sm={6} className="introRow1Column1">
                            <Card className="introRowTile">
                                <Card.Body>
                                    <h3 className="homeH3">Scholarships</h3>
                        ...
                        <Col sm={6}  className="introRow1Column2">
                            <Card className="introRowTile">
                                <Card.Body>
                                    <h3 className="homeH3">More Info</h3>
