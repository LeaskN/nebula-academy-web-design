                    ...
                    <Row className="staticCard">
                        ...
                        <Col xs={8} className="cardColumns offWhite">
                            ...
                            {this.state.toggle.button2 ? <Card className="cardDeckRight">
                                    <Card.Body>
                                        <h1 className="curriculumH1">Budgets & Timelines to Support your Capabilities</h1>
                                        <Row>
                                            <Col xs={10} md={12}>
                                                <p className="curriculumText">Every customer has unique budget structures that support new initiatives and long-term planning goals. Understanding cost models for implementation along with current capacity and future capacity allows for a strategy that is structured for long term success.</p>
                                            </Col>
                                        </Row>
                                    </Card.Body>
                            </Card>: null}
                            ...
                            {this.state.toggle.button4 ? <Card className="cardDeckRight">
                                    <Card.Body>
                                            <h1 className="curriculumH1">Execution on Strategy:</h1>
                                            <Row>
                                                <Col xs={10} md={12}>
                                                    <p className="curriculumText">Through collaboration with customers we design a strategy that defines a vision, strategic goals, budget alignment, and time-line. Through a multi-year plan, we introduce computer science at a pace that fits our customers’ culture and capacity to successfully deliver.</p>
                                                </Col>
                                            </Row>
                                    </Card.Body>
                            </Card>: null}
                    ...
                    <Row className="staticCard">
                        ...
                        <Col xs={8} className="cardColumns">
                            ...
                            {this.state.toggle2.scheduleButton2 ? <Card className="cardDeckRight">
                                    <Card.Body>
                                        <h1 className="curriculumH1">Planned First Step</h1>
                                            <Row>
                                                <Col xs={10}md={12}>
